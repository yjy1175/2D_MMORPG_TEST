	...
	public class Map
	{
		...
		public bool CanGo(Vector2Int cellPos, bool checkObjects = true)
		{
			...
			return !collision[MaxY - cellPos.y, cellPos.x - MinX] 
				&& (!checkObjects || players[MaxY - cellPos.y, cellPos.x - MinX] == null);
		}
		public void LoadMap(int mapId, string pathPrefix = "../../../../../Common/MapData")
		{
			...
			// Collision
			string _mapData = File.ReadAllText($"{pathPrefix}/{_mapName}.txt");
			StringReader _reader = new StringReader(_mapData);
			...
			players = new Player[_yCount, _xCount];
		...
		public Player FindByPos(Vector2Int pos)
        {
			...
			return players[MaxY - pos.y, pos.x - MinX];
        }
